...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.carrierPost.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.carrier-posts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('departure_time') ? 'is-invalid' : '' }}" type="text" name="departure_time" id="departure_time" value="{{ old('departure_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('free_weight') ? 'is-invalid' : '' }}" type="number" name="free_weight" id="free_weight" value="{{ old('free_weight', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('free_area') ? 'is-invalid' : '' }}" type="text" name="free_area" id="free_area" value="{{ old('free_area', '') }}">
