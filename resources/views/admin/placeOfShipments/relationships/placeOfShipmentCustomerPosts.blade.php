...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-placeOfShipmentCustomerPosts">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.customerPost.fields.place_of_shipment') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($customerPosts as $key => $customerPost)
                        <tr data-entry-id="{{ $customerPost->id }}">
                            ...
                            <td>
                                {{ $customerPost->from->name ?? '' }}
                            </td>
                            <td>
                                {{ $customerPost->to->name ?? '' }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ $customerPost->place_of_shipment->name_ru ?? '' }}
                            </td>
                            <td>
                                {{ $customerPost->price ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-placeOfShipmentCustomerPosts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
