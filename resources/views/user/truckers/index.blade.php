...
{{--        carrierPosts  --}}
        ...
        <div class="mt-2">
            ...
            <div class="hidden md:grid grid-cols-9 text-center text-sm md:pr-3 lg:px-0 py-5 xl:py-3 shadow-md font-medium bg-white rounded-lg">
                <div onclick="openCaption(this.id)" id="1" class="col-span-8 grid grid-cols-8">
                    <div class="col-span-1">{{$c_p->from['name_'.$locale]}}</div>
                    <div class="col-span-1">{{$c_p->to['name_'.$locale]}}</div>
                    <div class="col-span-1"> {{$c_p->from['name_'.$locale]}}</div>
                    <div class="col-span-1">22K kg</div>
                    <div class="col-span-1">Temir</div>
                    <div class="col-span-1 font-bold">Zavtra</div>
                    <div class="col-span-1 text-white bg-theme-{{$c_p->status==1?"9":"6"}} rounded">{{$c_p->status==1?"Svoboden":"Zaynet"}}</div>
                    <div class="col-span-1">5000$</div>
                </div>
                <div class="col-span-1">
                    <a href="#" onclick="alert('{{\App\Models\PhoneNumber::where('user_id',$c_p->user->id)->first()}}')" class="button text-white px-0 md:px-1 lg:px-2 xl:px-6 bg-theme-9 w-full">связьция</a>
                </div>
            ...
            <div onclick="openCaption(1)" id="1" class="grid grid-cols-12 md:hidden shadow-md bg-white rounded-lg p-5 mt-4 font-medium">
                ...
                <div id="caption-1" class="col-span-12 text-left caption-hidden">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                    cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
        ...
        <div class="mt-10 md:mt-2">
            ...
            <div onclick="openCaption(this.id)" id="3" class="grid grid-cols-12 md:hidden shadow-md bg-white rounded-lg p-5 mt-4 font-medium">
                <div class="col-span-4 mt-4"><span class="text-xl mt-6 font-bold text-theme-1">5000 USD</span>
                </div>
        ...
        <div class="mt-10">
            ...
            <div onclick="openCaption(2)" id="1" class="grid grid-cols-12 md:hidden shadow-md bg-white rounded-lg p-5 mt-4 font-medium">
                ...
                <div id="caption" class="col-span-12 text-left caption-hidden">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
                    cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
