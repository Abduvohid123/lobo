...
@section('data-list')
    ...
    <div style="overflow-x: auto;" class="intro-y col-span-12 lg:overflow-visible">
        ...
        <div>
            ...
            <div class="hidden md:grid grid-cols-8 text-center text-sm md:pr-3 lg:px-0 py-5 mt-2 xl:py-3 shadow-md font-medium bg-white rounded-lg">
                <div onclick="openCaption(this.id)" id="1" class="col-span-7 grid grid-cols-7">
                    <div class="col-span-1">{{$customerPost->from_city}}</div>
                    <div class="col-span-1">{{$customerPost->to_city}}</div>
                    <div class="col-span-1">{{$customerPost->load}}</div>
                    <div class="col-span-1">{{$customerPost->weight}} kg</div>
                    <div class="col-span-1">{{$customerPost->area}}</div>
                    <div class="col-span-1">{{$customerPost->date}}</div>
                    <div class="col-span-1">{{$customerPost->price}}</div>
                </div>
                <div class="col-span-1">
                    <a href="#" class="button text-white px-1 md:px-2 lg:px-4 xl:px-8 bg-theme-9 w-full">связьция</a>
                </div>
                   
                <div id="caption-1" class="col-span-8 px-5 text-left caption-hidden"></div>
