...
class CarriersApiController extends Controller
{
    public function index()
    {
        ...
        return new CarrierResource(Carrier::with(['user', 'vehicle_model', 'delivery_type', 'vehicle_type', 'trailer_size'])->get());
    }
    ...
    public function show(Carrier $carrier)
    {
        ...
        return new CarrierResource($carrier->load(['user', 'vehicle_model', 'delivery_type', 'vehicle_type', 'trailer_size']));
    }
